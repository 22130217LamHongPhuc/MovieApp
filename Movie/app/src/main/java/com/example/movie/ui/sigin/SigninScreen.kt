...
// 4.2.28 Hệ thống thực hiện load giao diên trang SigninScreen
@Composable
fun SiginScreen(viewmodel: SiginViewmodel = hiltViewModel(), activity: ComponentActivity, navController: NavController, loginFacebook:()-> Unit) {
    ...
    when(stateSignin.value){
        // 4.2.34 Hiển thị giao diện trạng thái đang loading
        ...
        is UiState.Success -> {
            ...
            // 4.2.40 Hiển thị thông báo đăng nhập thành công
    ...
    // 4.2.29 Hệ thống hiển thị giao diện SiginScreen
    ...
    ConstraintLayout(modifier = Modifier.fillMaxSize()) {
        ...
        FormSignin(Modifier.constrainAs(formRef){
            ...
            email,pass ->
            coroutineScope.launch {
                // 4.2.32 Hệ thống thực hiện gọi phương thức siginWithEmail(email,pass) trong SiginViewmodel
...
fun FormSignin(modifier: Modifier,signinWithEmail:(String,String) -> Unit,signinWithFacebook:() -> Unit,signin:() -> Unit) {
    ...
    Column(modifier = modifier
        ...
        // 4.2.30 Người dùng thực hiện nhập thông tin tài khoản  để thực hiện đăng nhập
        ...
        // 4.2.31 Người dùng thực hiện nhấn vào nút đăng nhập
